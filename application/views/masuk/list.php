	...
	<div class="bgwhite">
		...
		<div class="col-md-12">
			...
			echo validation_errors('<div class="alert alert-warning">','</div>');
				...
				// Display notofikasi error login
			...
			// Display notofikasi sukses logout
			...
			<table class="table"> 
				...
				<tbody>
					...
					<tr>
						<td></td>
						<td>
							<button class="btn btn-success btn-lg" type="submit"><i class="fa fa-save"></i> Login
							</button>
							<button class="btn btn-default btn-lg" type="reset"><i class="fa fa-times"></i> Reset
							</button>
						</td>
					</tr>
				</tbody>
